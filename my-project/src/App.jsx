...
function App() {
  ...
  const getNews = async () => {
    try {
      const response = await axios.get('https://newsapi.org/v2/everything?q=tesla&from=2024-07-28&sortBy=publishedAt&apiKey=ea16efd7d7d54fa58aec7094fd025f92');
      console.log('getNews: ', response.data.response);
    } catch (error) {
      console.error(error)
    }
  }
